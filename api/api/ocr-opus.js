...
//   3. Dùng đúng file NKT_Inspect_Pro_v58_opus.html đã cấu hình sẵn URL này —
...
export default async function handler(request) {
  ...
  try {
    ...
    const model = 'claude-opus-4-8'; // bản so sánh Opus — input $5/MTok, output $25/MTok, giữ tới 4784 ô ảnh
